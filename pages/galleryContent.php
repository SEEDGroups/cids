<div id="fh5co-main">
  ...
  <div class="row animate-box" data-animate-effect="fadeInLeft">
    <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
      <a href="work.php?act=<?php echo substr(sha1('view-video-'), 9,9); ?>">
        <iframe width="400" height="250" src="https://www.youtube.com/embed/CevxZvSJLk8" frameborder="0" allowfullscreen></iframe>
        <h3 class="fh5co-work-title">Video Title Here</h3>
        <p>Illustration, Branding</p>
      </a>
    </div>
    <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
      <a href="work.php?act=<?php echo substr(sha1('view-video-'), 9,9); ?>">
      <iframe width="400" height="250" src="https://www.youtube.com/embed/KlyXNRrsk4A?rel=0" frameborder="0" allowfullscreen></iframe>
        <h3 class="fh5co-work-title">Video Title Here</h3>
        <p>Web, Packaging</p>
      </a>
    </div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
      <a href="work.php?act=<?php echo substr(sha1('view-video-'), 9,9); ?>">
        <iframe width="400" height="250" src="https://www.youtube.com/embed/7RMQksXpQSk?rel=0" frameborder="0" allowfullscreen></iframe>
        <h3 class="fh5co-work-title">Video Title Here</h3>
        <p>Branding, Web</p>
      </a>
    </div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
      <a href="work.php?act=<?php echo substr(sha1('view-video-'), 9,9); ?>">
        <img src="<?php echo images_url;?>/video1.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
          <!-- <iframe width="400" height="250" src="https://www.youtube.com/embed/J_ub7Etch2U?rel=0" frameborder="0" allowfullscreen></iframe> -->
        <h3 class="fh5co-work-title">Video Title Here</h3>
        <p>Web, Packaging, Branding</p>
      </a>
    </div>
