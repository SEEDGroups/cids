<div id="fh5co-main">
  ...
  <div class="fh5co-narrow-content">
    <div class="row">
      ...
      <div class="col-md-6 col-md-push-1 animate-box" data-animate-effect="fadeInLeft">
        <img src="<?php echo images_url;?>/img_1.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive">
      </div>
    </div>
  ...
  <div class="fh5co-narrow-content  animate-box" data-animate-effect="fadeInLeft">
    ...
    <div class="row">
      <div class="col-md-4 fh5co-staff">
        <img src="<?php echo images_url;?>/person3.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive">
        <h3>Athan Smith</h3>
      ...
      <div class="col-md-4 fh5co-staff">
        <img src="<?php echo images_url;?>/person2.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive">
      ...
      <div class="col-md-4 fh5co-staff">
        <img src="<?php echo images_url;?>/person4.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive">
        <h3>Yanna Kuzuki</h3>
  ...
  <div class="fh5co-counters" style="background-image: url(<?php echo images_url;?>/hero.jpg);" data-stellar-background-ratio="0.5" id="counter-animate">
